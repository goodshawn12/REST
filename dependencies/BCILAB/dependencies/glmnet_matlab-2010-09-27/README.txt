...
* type "help <command>" in MATLAB for the usage and examples for each command.

* Currently sparse format is NOT supported.
...
glmnetMex.mexmaci, compiled with MAC OS X 10.6.3 and Matlab 2009a (32 bit).
...
glmnetMex.mexmaci was kindly provided by Pablo Escandell Montero from the University of Valencia.
cvglmnetMulticlass.m was kindly provided by Kevin Murphy from University of British Columbia.
