...
if nargin == 2
   [errorcode rows columns] = myrndcheck(2,2,a,b);
end

if nargin == 3
   [errorcode rows columns] = myrndcheck(3,2,a,b,m);
end

if nargin == 4
   [errorcode rows columns] = myrndcheck(4,2,a,b,m,n);
end
