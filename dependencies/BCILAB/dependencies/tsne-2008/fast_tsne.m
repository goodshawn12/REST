...
% Maastricht University, 2008
    ...
    if ispc
        system([dependency_path filesep 'tsne' filesep 'tSNE.exe']);
    elseif isunix
        system([dependency_path filesep 'tsne' filesep 'tSNE_linux']);
    else
        system([dependency_path filesep 'tsne' filesep 'tSNE_maci']);
    end
