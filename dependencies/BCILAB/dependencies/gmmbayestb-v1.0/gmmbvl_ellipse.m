function h = gmmbvl_ellipse(ra,rb,ang,x0,y0,C,Nb)
...
%
% note that if ra=rb, gmmbvl_ELLIPSE plots a circle
%
...
% NOTE: this is a slightly modified version for octave
...
%% OCTAVE
  plot(radm*cos(the)*co-si*radn*sin(the)+xpos,radm*cos(the)*si+co*radn*sin(the)+ypos,'k-');
%%
