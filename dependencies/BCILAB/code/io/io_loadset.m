...
allopts = arg_define([0 1],varargin,...
    ...
    arg_subtoggle({'markerchannel','MarkerChannel'},{},@set_infer_markers,'Marker channel processing. Optional parameters to control the marker channel processing function.'), ...
    ... % chanlocs handling
...
if isempty(res.event) || (allopts.markerchannel.arg_selection && allopts.markerchannel.force_processing)
