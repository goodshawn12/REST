...
opts = arg_define(varargin, ...
    ...
    arg({'srate','SamplingRate'},512,[0 Inf],'Sampling rate of the input data. Depends on the amplifier & DataRiver settings. If specified ,takes precedence of the sampling rate in the data source.'), ...
