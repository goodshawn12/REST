...
arg_define(varargin, ...
    ...
    arg({'hmObj','TemplateHeadModel','HeadModelObject'},headmodel_default,[],'Head model object generated by MOBILAB. See MOBILAB''s headModel class.','typecheck',false), ...
...
if ~exist('state','var') || isempty(state)
   % construct state
    ...
    [dummy,loc1,loc2] = intersect(lower(hmObj.channelLabel),chans,'stable');  % FIXME: this does not work with versions of Matlab prior to 2012
