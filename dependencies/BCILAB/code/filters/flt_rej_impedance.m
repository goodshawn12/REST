...
arg_define(varargin, ...
    ...
    arg({'imp_period','ImpedancePeriod'},4,uint32([0 1000000]),'Period (samples) for impedance calculation'), ...
    arg({'TO_V','VoltConversion'},1e-6,[],'Factor for converting signal units to volts'), ... 
