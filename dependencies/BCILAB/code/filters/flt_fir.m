...
arg_define(varargin, ... 
    ...
    arg({'passripple','PassbandRipple'}, -20, [-180 -80 0.1 1], 'Maximum relative ripple amplitude in pass-band. Relative to nominal pass-band gain. Affects the filter length (i.e., delay). Assumed to be in db if negative, otherwise taken as a ratio.'), ...
    arg({'stopripple','StopbandRipple'}, -40, [-180 -80 0.1 1], 'Maximum relative ripple amplitude in stop-band. Relative to nominal pass-band gain. Affects the filter length (i.e., delay). Assumed to be in db if negative, otherwise taken as a ratio.'), ...
