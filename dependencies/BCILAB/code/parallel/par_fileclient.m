...
args = arg_define(0:2,varargin, ...
    ...
    arg({'timeout_accept','TimeoutAccept',},60*30,[],'Timeout to start file transmission. In seconds. If a client takes longer than this to initiate transmission we give up.','guru',true), ...
