...
special_dependencies = { ...
    ...
    ... % SIFT/NeuroScale additions
    'PythonMatlabTransceiver','siftTransceiverTcp','siftMessage','siftTransceiver', ...
    'on_message','warn_once','headModel','mvar_BSBL_BO','mvar_arfit','mvar_dalSCSA', ...
    'mvar_glADMM','mvar_ridge','mvar_scsa_em','mvar_vieiramorf',...
    ... % more stuff
