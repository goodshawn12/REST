...
opts = arg_define(varargin, ...
    ...
    arg({'bufferrange','BufferRange'},10,[0 Inf],'Maximum time range to buffer. In seconds; imposes an upper limit on what can be displayed.'), ...
    ...
    arg({'refreshrate','RefreshRate'},5,[0 1000],'Refresh rate for display. This is the rate at which the graphics are updated.'), ...
