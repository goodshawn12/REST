function inlet = vis_stream(varargin)
...
opts = arg_define(varargin, ...
    ...
    arg({'bufferrange','BufferRange'},360,[0 Inf],'Maximum time range to buffer. In seconds; imposes an upper limit on what can be displayed.'), ...
