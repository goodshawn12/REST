...
bufflen = 60; % seconds
% assignin('base','conv_statIdx',nan(1,bufflen*calibData.srate));
...
%     warning('REST - Localization: Unsure about channel space units. Trying meters instead of millimeters.')
