function [gamma,s,w,cost,k,dgamma] = nut_Champagne_2x2(y,F,Sigma_e,iters,gamma_init);
% *************************************************************************
% 
% *** Purpose ***
...
while (1)
    ...
    disp(['On EM iteration ' num2str(k) ', Champagne has gamma ' num2str(dgamma) ' relative to threshold ' num2str(MIN_DELTA_GAMMA)]);
    ...
    toc
    disp('time to invert Gamma matrix');
