...
% $Revision: 1.7 $ $Date: 2007/04/17 20:48:26 $
...
elseif strmatch('MEG42RS',ctf.res4.header),
        % OK, we can handle this format
else
    msg = sprintf('This function is designed to read MEG41RS or MEG42RS format.\nIt may not read "%s" format correctly',ctf.res4.header);
    warning(msg);
end
