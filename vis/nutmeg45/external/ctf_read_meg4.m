...
% $Revision: 1.6 $ $Date: 2006/12/10 03:05:51 $
...
channel_gain = zeros(1,ctf.setup.number_channels,'single');
...
ctf.data = zeros(number_samples, number_channels, number_trials,'single');
...
for trial = 1:length(TRIALS),
  ...
  for channel = 1:length(CHAN),
    ...
    channel_samples = fread(fid, [ctf.setup.number_samples,1], 'int32=>single');
