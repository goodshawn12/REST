function [ctf] = ctf_read(folder,CHAN,TIME,TRIALS,COEFS,VERBOSE);
...
% ctf_read.
%
% VERBOSE: If verbose = 1, display 'ctf.setup' structure (default if not selected)
...
ctf = ctf_read_res4(ctf.folder,VERBOSE,COEFS);
