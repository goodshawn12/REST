...
datafile='/net/pppjz.nottingham.ac.uk/zumer/somato_demo_testing/ZumerJohanna_SEF_20031212_01_bl.ds/ZumerJohanna_SEF_20031212_01_bl.meg4';
...
switch optionmode
    case 'mni'
        ...
        nut_create_nuts(datafile,'sessionfile',sessfile,'mrifile',mrifile,'mnifile',mnifile);
    case 'voxels'
        mrifile='/net/cador/Anatomical_Library/JZumer/zumerN.img';
        voxfile='/net/pppjz.nottingham.ac.uk/zumer/somato_demo_testing/voxels.mat';
        nut_create_nuts(datafile,'sessionfile',sessfile,'mrifile',mrifile,'voxelsfile',voxfile);
end