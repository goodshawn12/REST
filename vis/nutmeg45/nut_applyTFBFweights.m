function nut_applyTFBFweights(sessionfile, covfile, weightsfile, timeselect, algo, covfile_usechar, voxind, paramsfile, dualstate)
% function nut_applyTFBFweights(sessionfile, covfile, weightsfile, timeselect, algo, covfile_usechar, voxind, paramsfile, dualstate)
...
if ~exist('voxind') || isempty(voxind)
    if params.savepower
