...
% Start EEG stream
inlet = vis_stream_ORICA('StreamName',handles.streamName,'figurehandles',handles.figure1,'axishandles',handles.axisEEG);
...
% result = {};
% disp(['Looking for a stream with name=' handles.streamName ' ...']);
% while isempty(result)
%     result = lsl_resolve_byprop(lib,'name',handles.streamName); end
% % create a new inlet
% disp('Opening an inlet...');
% inlet = lsl_inlet(result{1},360);
% assignin('base',handles.streamName,inlet);
