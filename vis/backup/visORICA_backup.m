function varargout = visORICA_backup(varargin)
% VISORICA_BACKUP MATLAB code for visORICA_backup.fig
%      VISORICA_BACKUP, by itself, creates a new VISORICA_BACKUP or raises the existing
%      singleton*.
%
%      H = VISORICA_BACKUP returns the handle to a new VISORICA_BACKUP or the handle to
%      the existing singleton*.
%
%      VISORICA_BACKUP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VISORICA_BACKUP.M with the given input arguments.
%
%      VISORICA_BACKUP('Property','Value',...) creates a new VISORICA_BACKUP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before visORICA_backup_OpeningFcn gets called. An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to visORICA_backup_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @visORICA_backup_OpeningFcn, ...
    'gui_OutputFcn',  @visORICA_backup_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
function visORICA_backup_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to visORICA_backup (see VARARGIN)
%   1: channel locations
...
% Choose default command line output for visORICA_backup
...
function varargout = visORICA_backup_OutputFcn(hObject, eventdata, handles)
