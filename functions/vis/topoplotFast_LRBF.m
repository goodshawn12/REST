...
function [handle,Zi,grid,Xi,Yi,intx,inty] = topoplotFast_LRBF(Values,loc_file,varargin)
...
%   op = rbfcreate(double([inty;intx]),double(intValues'),'RBFFunction', 'linear');
%   Zi = reshape(rbfinterp(double([Xi(:),Yi(:)]'), op),size(Xi));
